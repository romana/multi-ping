...
if __name__ == "__main__":
    ...
    print "   received responses:  ", responses.keys()
    print "   no responses so far: ", no_responses
    ...
    print "   received responses:  ", responses.keys()
    print "   still no responses:  ", no_responses
    print
    ...
    if no_response:
        print "    no response received in time, even after 3 retries: ", \
                        no_response
    print
    ...
    print "    reponses: ", responses.keys()
    if no_responses:
        print "    no response received in time, even after retries: ", \
                        no_response
